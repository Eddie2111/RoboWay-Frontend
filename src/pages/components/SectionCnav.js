import { 
    GridItem, SimpleGrid, Button, ButtonGroup, CardFooter, Text, 
    CardBody, Card, Heading, Image, Stack, Divider, CardHeader } from '@chakra-ui/react';
            ...
            <SimpleGrid columns={[1, null, 3]} spacingY='450px' paddingBottom={"350px"}>
                ...
                <Card maxW='sm' h="420">
                    <CardBody align={"center"}>
                        ...
                        <Text>
                        Our founding Member XYZ is one of the team members of Bracu Duburi an Autonomous underwater Vehicle which participated in Robosub 2022, USA and went to the semifinals.
                        </Text>
                        </Stack>
                    </CardBody>
                    <Divider />
                ...
                <Card maxW='sm' h="420">
                    <CardBody>
                        ...
                        <Text>
                        BRACU Dichari is working alongside Firemen and Disaster management, this project is the ultimate solution to the problem of fire in Bangladesh.
                        </Text>
                        </Stack>
                    </CardBody>
                    <Divider />
